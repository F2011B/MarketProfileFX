...
class QCP_LIB_DECL QCPFinancial : public QCPAbstractPlottable1D<QCPFinancialData>
{
  ...
  /// \endcond
    void setCandleStickStandardColors(QCPPainter *painter, QCPFinancialDataContainer::const_iterator it, bool isSelected);
...
public:
  ...
  */
  enum ChartStyle { csOhlc         ///< Open-High-Low-Close bar representation
                   ...
                   ,csHollowCandle ///< Hollow Candlestick representation>
                   ,csLineClose    ///< Drawing only a line for the close can be used to represent movingaverages as well, too
                   ,csOhlcPaintbar
                  };
  Q_ENUMS(ChartStyle)
  ...
  void setHollowCandleBrush(QCPPainter *painter, QBrush boxBrush, QCPFinancialDataContainer::const_iterator it, bool isSelected);
...
protected:
  ...
  void drawOhlcPaintBar(QCPPainter *painter, const QCPFinancialDataContainer::const_iterator &begin, const QCPFinancialDataContainer::const_iterator &end);
  ...
  void drawCandlestickPaintBar(QCPPainter *painter, const QCPFinancialDataContainer::const_iterator &begin, const QCPFinancialDataContainer::const_iterator &end, bool isSelected);
  void drawHollowCandlestickPlot(QCPPainter *painter, const QCPFinancialDataContainer::const_iterator &begin, const QCPFinancialDataContainer::const_iterator &end, bool isSelected);
  void drawLineForClosePlot(QCPPainter *painter, const QCPFinancialDataContainer::const_iterator &begin, const QCPFinancialDataContainer::const_iterator &end, bool isSelected);
